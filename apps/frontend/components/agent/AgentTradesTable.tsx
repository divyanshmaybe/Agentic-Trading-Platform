...
import { formatCurrencyInteger, formatDuration } from "@/lib/utils/formatters"
...
export function AgentTradesTable({ trades: initialTrades, loading: initialLoading, agentType }: AgentTradesTableProps) {
